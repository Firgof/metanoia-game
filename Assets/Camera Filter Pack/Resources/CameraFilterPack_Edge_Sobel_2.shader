...
////////////////////////////////////////////
Shader "CameraFilterPack/Edge_Sobel_2" {
Properties
{
...
_CutOff ("Threshold cutoff", Range(0.0, 1.0)) = 0.5
}
SubShader
{
...
color += step(_CutOff, dot(tex2D(_MainTex, center).xyz, float3(0.299,0.587,0.114) ));
